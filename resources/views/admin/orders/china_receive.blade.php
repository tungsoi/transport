                        ...
                        <table class="table table-bordered" id="tbl-orders">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="kg[]" class="form-control kg" placeholder="Nhập cân nặng" value="">
                                    </td>
                                    <td>
                                        <input type="number" name="product_length[]" class="form-control product_length" placeholder="Nhập chiều dài" value="">
                                    </td>
                                    <td>
                                        <input type="number" name="product_width[]" class="form-control product_width" placeholder="Nhập chiều rộng" value="">
                                    </td>
                                    <td>
                                        <input type="number" name="product_height[]" class="form-control product_height" placeholder="Nhập chiều cao" value="">
                                    </td>
                                    <td>
